...
public class GuestBookingController {
	...
	@PostMapping("/book/{id}")
	public String saveBooking(@PathVariable(value="id") String bId,@Validated @RequestBody Guest book) throws ResourceNotFoundException
	{
		...
		bookd.setBusId(bId);
		bookd.setPassengerName(book.getPassengerName());
		bookd.setNumberOfseats(book.getNumberOfseats());

		bookd.setTotalCost(book.getTotalCost());
		bookd.setEmail(book.getEmail());
		...
		bookd.setPhoneNumber(book.getPhoneNumber());
		bookd.setCreditDebitCard(book.getCreditDebitCard());
		bookd.setNameOnCard(book.getNameOnCard());
		bookd.setCvv(book.getCvv());
		bookd.setExpMonth(book.getExpMonth());
		bookd.setExpYear(book.getExpYear());
		bookd.setDateOfBooking(date);
		bookd.setBusType(busType);
		bookd.setTotalCost(book.getTotalCost());
		bookd.setJourneyDate(busd.getDate());
		int temp=book.getNumberOfseats();
